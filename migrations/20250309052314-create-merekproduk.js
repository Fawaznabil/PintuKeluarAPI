...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('merekproduks', {
      id: {
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
      ...
      produkdetailId: {
        ...
        allowNull: false,
        references: {
          model: 'produkdetails', // Nama tabel harus sesuai dengan yang dibuat Sequelize
          key: 'id'
        },
        onUpdate: 'CASCADE',
        onDelete: 'CASCADE'
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('merekproduks');
  }
};